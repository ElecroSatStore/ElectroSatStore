        ...
        <ul className="flex flex-col gap-3 mt-3">
              {
                ...
                <li onClick={LOGOUT} className="border font-medium hover:cursor-pointer hover:bg-gray-200 border-gray-200 py-2.5 rounded-xl px-2 text-red-500 flex items-center gap-2 text-sm"><Logout width={15} height={15} color={"#fb2c36"}/> Deconnecter</li>       
