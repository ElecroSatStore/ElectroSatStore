            ...
            <Box className = 'absolute bg-white rounded-xl px-6 py-6 -translate-x-1/2 -translate-y-1/2 w-11/12 sm:w-2/3 md:w-1/2 lg:w-7/12 xl:w-6/12 border-none outline-none top-1/2 left-1/2 h-[400px] overflow-y-auto'>
                ...
                <div>
                   ...
                   <div className="flex justify-between items-center border-b border-gray-300 py-2">
                      ...
                      <p className="mb-0 text-base text-[#484848] font-medium flex gap-1 items-center">Prix : {(product.price * quantity)+ wilaya[idWilaya].prix} <span className="text-white bg-blue-500 rounded-md px-1 text-sm">x{quantity}</span></p>
                   </div>
                   <div className="flex justify-between items-center border-b border-gray-300 py-2">
